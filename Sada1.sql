...
insert into members(surname, member_name) values ('Lennon', 'John')
insert into members(surname, member_name) values ('McCartney', 'Paul')
...
insert into bands (band_ID, band_name, origin_country, formed_year) values ('2', 'Queen', 'Great Britain', '1971')
...
Ano je to tak, v predeslem kroku si vytvorila integritni omezeni na formed_year vetsi nez 1920 a ted se pokousis vlozit zaznam mensi nez dane omezeni. Databaze spravne vypsala vyse zminenou chybu.